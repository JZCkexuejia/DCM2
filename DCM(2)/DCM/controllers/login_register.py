...
from controllers.dcm_interface import DCMInterface
...
class LoginRegister(QMainWindow, Ui_LoginRegister):
    def __init__(self):
        ...
        self.db = Database()
        self.db.connect()
        self.dashboard = DCMInterface(self)
    ...
    def setupUi(self, LoginRegister):
        ...
        self.lineEdit_password.returnPressed.connect(self.onclick_btn_login_register)
        self.lineEdit_username.returnPressed.connect(self.onclick_btn_login_register)
    ...
    def switch_state(self):
        if self.state == "LOGIN":
            ...
            self.label_register_login.setText("REGISTER")
            self.label_register_login_detail.setText("Don't have an account? Please register here.")
            self.btn_register_login.setText("Register")
        else:
            self.label_login_register.setText("REGISTER")
            self.label_login_register_detail.setText("Please enter the details to register")
            self.btn_login_register.setText("Register")
            self.label_register_login.setText("LOGIN")
            self.label_register_login_detail.setText("Already have an account? Login here.")
            self.btn_register_login.setText("Login")
